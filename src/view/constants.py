        ...
        (
            (
                [
                    ...
                    [
                        ID_ENTERPRISE_APP_PROJECT,
                        'Enterprise Application Project',
                        'enterprise_app.png',
                        None,
                    ],
                    [
                        ID_DYNAMIC_WEB_PROJECT,
                        'Dynamic Web Project',
                        'create_dynamic_web_project.png',
                        None,
                    ],
                    [ID_EJB_PROJECT, 'EJB Project', 'ejb_project.png', None],
                    [
                        ID_CONNECTER_PROJECT,
                        'Connecter Project',
                        'connecter_prj.png',
                        None,
                    ],
                    [
                        ID_APP_CLIENT_PROJECT,
                        'Application Client Project',
                        'app_client_prj.png',
                        None,
                    ],
                    [
                        ID_STATIC_WEB_PROJECT,
                        'Static Web Project',
                        'static_web_project.png',
                        None,
                    ],
                    [
                        ID_JPA_PROJECT,
            ...
            + [
                ...
                [
                    ID_MESSAGE_DRIVEN_BEAN,
                    'Message-Driven Bean (EJB 3.x)',
                    'message_driven_bean.png',
                    None,
                ],
